  ...
  <div class="sl-pagebody">
    <div class="sl-page-title">
      <h1>All Orders</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 pt-5 pb-5"><h4><strong>Total Success : {{ auth_complete_order() }}</strong></h4></div>
                <div class="col-lg-4 pt-5 pb-5"><h4><strong>Active : {{ auth_active_order() }}</strong></h4></div>
                <div class="col-lg-4 pt-5 pb-5"><h4><strong>Request : {{ auth_new_order() }}</strong></h4></div>
                <div class="col-lg-12">
